...
-- 1. SAFE GUI CHECK
local oldGui = playerGui:FindFirstChild("Elite_Aim_System")
...
local espEnabled = false -- New ESP State
...
-- 3. Optimized ESP Logic (Memory & Performance Focused)
local function applyESP(targetPlayer)
	...
	local function createHighlight(char)
		...
		highlight.OutlineColor = Color3.fromRGB(255, 0, 0) -- Red Elite Style
		highlight.OutlineTransparency = 0
		highlight.Enabled = espEnabled -- Sync with current menu state
...
-- 5. Menu Creation (Adjusted Height for ESP Button)
local mainPanel = Instance.new("Frame")
mainPanel.Size = UDim2.new(0, 200, 0, 335) -- Increased height
...
local espToggleBtn = Instance.new("TextButton", content) -- NEW ESP BUTTON
...
local tpRangeIn, tpRangeLabel = createInput("TP Range:", 15, "5")
...
closeBtn.MouseButton1Click:Connect(function() 
	workspace.Gravity = originalGravity
	toggleAllHighlights(false) -- Clean up visuals
